...
const BedbankSection = () => {
  ...
  return <section id="bedbank" className="relative py-32 overflow-hidden">
      {/* Background */}
      ...
      <div ref={ref} className="relative container mx-auto px-4 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          duration: 0.8
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">Whether you're an OTA scaling your Balkan inventory, a DMC seeking reliable supply, or a regional wholesaler expanding your reach, VasDream Bedbank delivers transparent availability and strong margins through API or Extranet.</p>
          ...
          delay: 0.2
            ...
            duration: 0.5,
            delay: 0.3 + index * 0.1
          }} className="spotlight-card spotlight-border glass rounded-xl p-6 group cursor-pointer" onMouseMove={e => {
            ...
            e.currentTarget.style.setProperty('--mouse-y', `${y}%`);
                ...
                <feature.icon size={28} className="text-accent mb-4 group-hover:scale-110 transition-transform duration-300" />
